...
<big>
    <form id="signup" action="modificap.php" method="post">
            <div class="sep"></div>
            <div class="inputs">
		Contraseña anterior: <?php echo $reg['pass'];?><br><br>
                Nueva contraseña: <input  type="text" placeholder="pass" name="pass" required autofocus />  *<br><br>
		Repetir contraseña <input type="text" placeholder="pass" name="pass2" required /> *
		<br><br>
